...
- Make the registration of the `@@locationsearch` view dependent on the availability of `geopy`.
  Fixes #15.
  [thet]
...
- Depend on z3c.unconfigure < 1.1 again.
  buildout.coredev is still depending on 1.0.1.
  [thet]

## 3.0.2 (2017-01-25)

- Remove z3c.unconfigure version dependency.
...
- Include a IEventAccessor implementation for IDXEvent and override the default
  implementation from plone.app.event. This implementation's location property
...
- Also support IEventAccessor in get_location and fix location not being
